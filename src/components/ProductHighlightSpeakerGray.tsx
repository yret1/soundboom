...
const ProductHighlightSpeakerOrange = () => {
  return (
    <section className='w-full p-6'>
            ...
            <article className='bg-[url("/src/assets/home/mobile/image-speaker-zx7.jpg")] md:bg-[url("/src/assets/home/tablet/image-speaker-zx7.jpg")] lg:bg-[url("/src/assets/home/desktop/image-speaker-zx7.jpg")] bg-cover bg-right h-96 flex items-center rounded-md'>
