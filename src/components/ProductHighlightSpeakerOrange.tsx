  ...
  return (
    <section className='w-full p-6'>
        ...
        <article className='bg-primary-100 rounded-md h-auto lg:relative lg:overflow-hidden'>
            <article className='bg-[url("/src/assets/home/desktop/pattern-circles.svg")] bg-bottom bg-no-repeat lg:bg-left-top'>
                <article className='flex flex-col justify-center items-center text-center py-20 px-12 lg:flex-row lg:gap-80 lg:relative lg:justify-end'>
                    <img className="w-44 mb-6 lg:w-96 lg:absolute lg:top-20 lg:left-40" src="/src/assets/home/mobile/image-speaker-zx9.png"></img>
